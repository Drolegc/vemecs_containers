...
public class Historial {
	...
	public Historial(int id, Paciente paciente, float presionMin, float presionMax, float volGas, int freqAporte,
			float porcenMezclaO2, float humedadAire, int pulsaciones, float tempEntradaAire, float tempSalidaAire,
