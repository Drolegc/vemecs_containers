    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                socket.on('connect', () => {
                    console.log("Conexion front - middleware ( master ) lista")
                })

                socket.on('frontMaster', (data) => {
                    console.log("Nuevos datos del vemec")
                ...
                socket.on('nuevoVemec', (data) => {
                    console.log("Señal de nuevo vemec registrado")
                    this.getVemecs()
                })

                socket.on('nuevoPaciente', (data) => {
                    console.log(data)
                    this.getPacientes()
                })
            },
            ...
            getMedicos() {
                this.$axios.get('http://localhost:8081/medicos/')
                    .then((data) => {
            ...
            getPacientes() {
                this.$axios.get(`http://localhost:8081/pacientes/`, {
                        headers: {
                            'Access-Control-Allow-Origin': '*'
                        }
                    })
            ...
            getVemecs() {
                this.$axios.get('http://localhost:8081/vemecs/', {
                        headers: {
                            'Access-Control-Allow-Origin': '*'
                        }
                    })
