...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getPaciente() {
        this.$axios.get(`http://picacode.ddns.net:8080/pacientes/vemec/${this.$route.params.id_vemec}`,{ headers: {'Access-Control-Allow-Origin': '*'} })
          .then((data)=>{
      ...
      getVemecs(){
        this.$axios.get('http://picacode.ddns.net:8080/vemecs/',{ headers: {'Access-Control-Allow-Origin': '*'} })
          .then((data)=>{
